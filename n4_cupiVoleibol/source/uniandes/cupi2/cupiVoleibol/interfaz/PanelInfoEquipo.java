...
public class PanelInfoEquipo extends JPanel implements ActionListener, ListSelectionListener
{
	...
	public void actualizarInfoEquipo(Object darNombre, String darCategoria,
			int darCantidadAficionados, ArrayList darJugadores,
			String darImagen, int darCantidadJugadoresSobrepeso) {
